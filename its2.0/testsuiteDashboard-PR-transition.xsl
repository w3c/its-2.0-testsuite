...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xsl:variable name="its2spec"
        >http://www.w3.org/TR/its20/</xsl:variable>
                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                ...
                                <li>Total number of tests successfully run from all implementers: <xsl:value-of select="$implementersTestsTotal - $testsWithErrors"
                                />.</li>
                            </ul>
                        </li> 
                        <li>
                        ...
                        <li>
                            <a href="#tests-details">Test details</a>
                        </li><!-- 
                        <li>
        ...
        <xsl:for-each select="$datacategories">
            ...
            <table border="1" width="100%">
                ...
                <xsl:for-each
                    ...
                    <tr>
                        <td>
                            <a  href="{$currentInputFile/@location}"
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <a href="{$currentInputFile/my:outputImplementors[@implementer=$currentImplementer]/@location}"><span class="ok">OK</span></a>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:otherwise>
                                </xsl:choose>
